...
const fullText1 = splitLines("dành tặng  TRÀ MY", 3);
const fullText2 = splitLines("mong em luôn xinh đẹp tươi cười hạnh phúc", 3);
const fullText3 = splitLines("VALENTINE ngọt ngào bây bi", 3);
...
function initHeartCache() {
  ...
  heartCtx.fillText("💗", heartCache.width / 2, heartCache.height / 2);
}
initHeartCache();
